...
With sales_ranks AS ( SELECT  seller_id,
						   product_category,
						   total_sales,
						   month,
						   DENSE_RANK()OVER (PARTITION BY product_category ORDER BY total_sales DESC) AS rank
					  FROM sales_data
...
| seller_id | total_sales | product_category | month       |
|-----------|------------:|------------------|-------------|
| s195      |   45633.35  | books            | 2024-01-01  |
| s728      |   29158.51  | books            | 2024-01-01  |
| s918      |   24286.40  | books            | 2024-01-01  |
| s483      |   49361.62  | clothing         | 2024-01-01  |
| s790      |   31050.13  | clothing         | 2024-01-01  |
| s375      |   18107.08  | clothing         | 2024-01-01  |
| s891      |   48847.68  | electronics      | 2024-01-01  |
| s863      |   46652.67  | electronics      | 2024-01-01  |
| s486      |   37009.18  | electronics      | 2024-01-01  |
| s712      |   43739.86  | toys             | 2024-01-01  |
| s830      |   39169.01  | toys             | 2024-01-01  |
| s123      |   36277.83  | toys             | 2024-01-01  |
| s749      |   36277.83  | toys             | 2024-01-01  |
...
With sales_ranks AS ( SELECT  seller_id,
						      market_place,
						      total_sales,
						      DENSE_RANK()OVER (PARTITION BY market_place ORDER BY total_sales DESC) AS rank
					  FROM sales_data
					)
  ...
  SELECT market_place,
	...
	FROM sales_ranks
	WHERE rank <=3
	ORDER BY market_place, total_sales DESC;	

```

| market_place | seller_id | total_sales |
|--------------|-----------|------------:|
| de           | s891      |   48847.68  |
| de           | s195      |   45633.35  |
| de           | s454      |   39090.88  |
...
WITH names AS (SELECT CONCAT(user_firstname,' ',user_lastname) AS user_name,
					  video_id, 
					  flag_id
				   FROM user_flags
				   WHERE flag_id NOTNULL
